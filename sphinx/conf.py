...
htmlhelp_basename = 'Spectra-Documentation'
...
latex_documents = [
    (master_doc, 'SpectraDoc.tex', 'Spectra Documentation',
     'kouui', 'manual'),
]
...
man_pages = [
    (master_doc, 'SpectraDoc', 'Spectra Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SpectraDoc', 'Spectra Documentation',
     author, 'SpectraDoc', 'One line description of project.',
     'Miscellaneous'),
]
